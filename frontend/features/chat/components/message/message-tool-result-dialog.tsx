  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent
          className="w-[calc(100vw-1rem)] gap-0 overflow-hidden p-0 sm:w-full sm:max-w-[720px]"
          onCloseAutoFocus={() => {
            setDetail(null);
            setLoading(false);
            setLoadFailed(false);
        ...
        >
          <DialogHeightTransition contentClassName="max-h-[calc(100dvh-1rem)] sm:max-h-[min(92vh,760px)]">
