...
export function useChatModelOptions({
  ...
  const keepLastUsedModel = userSettings["chat.keep_last_used_model"] === "true";
  const showMessagePositionRail = userSettings["chat.show_message_position_rail"] !== "false";
  const showResponseOutline = userSettings["chat.show_response_outline"] !== "false";
  ...
  }, [availableModels, conversationPublicID, newConversationDefaultModel, newConversationDefaultsPending, resetToken, userDefaultModel, keepLastUsedModel]);
